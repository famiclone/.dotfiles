...
local nkeymaps = {
  ...
  -- Rest
  ["<leader>rr"] = { cmd = "<Plug>RestNvim<CR>", mode = 'n', rpts = opts },
  ["<leader>rp"] = { cmd = "<Plug>RestNvimPreview<CR>", mode = 'n', opts = opts },
  ["<leader>rl"] = { cmd = "<Plug>RestNvimLast<CR>", mode = 'n', opts = opts },

  -- Telescope
  ["<leader>ff"] = { cmd = function() require("telescope.builtin").find_files() end, mode = 'n', opts = opts },
  ["<leader>fh"] = { cmd = function () require('telescope.builtin').help_tags() end, mode = 'n', opts = opts },
...
-- Diagnostic keymaps
  ["<leader>dm"] = { cmd = vim.diagnostic.open_float, mode = 'n', opts = opts },
  ["<leader>dl"] = { cmd = vim.diagnostic.setloclist, mode = 'n', opts = opts },
  ["[d"] = { cmd = vim.diagnostic.goto_prev, mode = 'n', opts = opts },
  ["]d"] = { cmd = vim.diagnostic.goto_next, mode = 'n', opts = opts },
}
